...
const AcceptedComplaints = React.lazy(() =>
  import('./views/pages/staff-complaints/AcceptedComplaints'),
)
//request
...
const AllFacultyRequest = React.lazy(() => import('./views/pages/teacher-request/AllRequest'))
