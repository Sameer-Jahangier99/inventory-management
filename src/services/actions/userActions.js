...
export const update = (name, email, password, role, phone) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(`${BASE_URL}/user/profile`, { name, email, password, role, phone }, config)
...
export const register = (name, email, password, role, phone) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`${BASE_URL}/user`, { name, email, password, role, phone }, config)
